...
router.get('/', (_req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      predictions: {
        'GET /predictions': 'Get Polymarket predictions with optional filters',
        'GET /predictions/:marketId': 'Get a specific prediction market',
        'POST /predictions/refresh': 'Force refresh predictions cache',
      },
    },
  });
});
